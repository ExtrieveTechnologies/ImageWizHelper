...
namespace ImageWizHelperCS
{
    class Program
    {
        ...
        {
            Console.WriteLine("Exe path"+" " + "-I <Input File>" + "-O <Output file>"  + "-CT " + "<[PDF" + "/TIFF" + "/JPG]>");//Message of Input format to run the exe.
        }
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                ObjimageWizHelper = new ImageWizHelper(CurrentPath); // Assigning object of the ImageWizHelper class. This same object will be used for calling every funtionalities of ImageWizHelper.
